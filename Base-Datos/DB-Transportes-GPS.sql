...
SELECT A.* FROM SMS_OPEN_ENCABEZADO A WHERE A.FECHA_ACTUALIZACION BETWEEN '2023-09-06 00:00:00' AND '2023-09-06 23:59:59';
SELECT B.* FROM SMS_OPEN_DETALLE B WHERE B.ID_SMS_OPEN IN (SELECT A.ID_SMS_OPEN FROM SMS_OPEN_ENCABEZADO A WHERE A.FECHA_ACTUALIZACION BETWEEN '2023-09-06 00:00:00' AND '2023-09-06 23:59:59');
...
SELECT A.* FROM DISPONIBILIDAD A WHERE A.FECHA='2023-09-07';
...
SELECT A.* FROM CLIENTE_DESTINO A WHERE A.CODIGO=731217;
UPDATE CLIENTE_DESTINO SET
ZONA_LATITUD_1=13.702889, ZONA_LONGITUD_1=-89.241672,
ZONA_LATITUD_2=13.702445, ZONA_LONGITUD_2=-89.241672,
ZONA_LATITUD_3=13.702445, ZONA_LONGITUD_3=-89.241092,
ZONA_LATITUD_4=13.702889, ZONA_LONGITUD_4=-89.241092,
ZONA_LATITUD_5=13.702889, ZONA_LONGITUD_5=-89.241672
WHERE CODIGO=731217;
