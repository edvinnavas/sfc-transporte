...
SELECT A.* FROM VIAJES A WHERE A.FECHA_VIAJE = '2023-10-06';
SELECT A.* FROM VIAJE_UBICACIONES A WHERE A.FECHA_HORA BETWEEN '2023-10-06 00:00:00' AND '2023-10-06 23:59:59';
SELECT A.* FROM DISPONIBILIDAD A;

-- CONSULTA DE UBICACIONES DEL PROVEEDORES DE GPS :: SMS-OPEN.
SELECT A.* FROM SMS_OPEN_ENCABEZADO A WHERE A.FECHA_ACTUALIZACION BETWEEN '2023-10-06 00:00:00' AND '2023-10-06 23:59:59';
...
WHERE V.FECHA_VIAJE='2023-10-04'
GROUP BY P.ID_PAIS;
...
FROM 
	(SELECT P.NOMBRE PAIS, V.ID_COMPANIA, V.ID_PLANTA, V.NUMERO_VIAJE, COUNT(*) NUMERO 
	 FROM VIAJES V LEFT JOIN PAIS P ON (V.ID_PAIS=P.ID_PAIS)
     WHERE V.FECHA_VIAJE='2023-10-06' 
