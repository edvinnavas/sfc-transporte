...
CREATE TABLE VIAJES (
    ...
    ETA TIMESTAMP,
    TIEMPO_RESTANTE DOUBLE,
	DISTANCIA_RESTANTE DOUBLE,
	ULTIMA_LATITUD DOUBLE,
	ULTIMA_LONGITUD DOUBLE,
    ID_CABEZAL BIGINT,
    ESTADO VARCHAR(3),
    ...
    CONSTRAINT FK_VIAJES_10 FOREIGN KEY (ID_CABEZAL) REFERENCES CABEZAL (ID_CABEZAL)
) ENGINE=INNODB DEFAULT CHARACTER SET=UTF8MB4;
