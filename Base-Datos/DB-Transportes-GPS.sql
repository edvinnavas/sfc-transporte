...
SELECT A.* FROM GEOTAB_ENCABEZADO A WHERE A.FECHA_ACTUALIZACION BETWEEN '2024-01-02 00:00:00' AND '2024-01-02 23:59:59';
SELECT A.* FROM GEOTAB_DETALLE A WHERE A.ID_GEOTAB IN (1973);
