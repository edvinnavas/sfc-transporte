...
INSERT INTO USUARIO (ID_USUARIO, NOMBRE_COMPLETO, NOMBRE_USUARIO, CONTRASENA, CORREO_ELECTRONICO, ACTIVO, DESCRIPCION, ID_ROL, FECHA_HORA) 
VALUES (17, 'ECSACR', 'ECSACR', SHA2('ECSACR', 512), '-', 1, 'Usuario transportista.', 2, CURRENT_TIMESTAMP);
...
SELECT A.* FROM VIAJE_UBICACIONES A WHERE A.FECHA_HORA BETWEEN '2023-12-18 00:00:00' AND '2023-12-18 23:59:59' AND A.ID_PAIS=4;

SELECT A.* FROM DISPONIBILIDAD A WHERE A.FECHA = '2023-12-18' AND A.ID_TRANSPORTISTA=5;

-- CONSULTA DE UBICACIONES DEL PROVEEDORES DE GPS :: SMS-OPEN.
SELECT A.* FROM SMS_OPEN_ENCABEZADO A WHERE A.FECHA_ACTUALIZACION BETWEEN '2023-12-16 00:00:00' AND '2023-12-16 23:59:59';
SELECT A.* FROM SMS_OPEN_DETALLE A WHERE A.ID_SMS_OPEN IN (14778);

-- CONSULTA DE UBICACIONES DEL PROVEEDORES DE GPS :: GEOTAB.
SELECT A.* FROM GEOTAB_ENCABEZADO A WHERE A.FECHA_ACTUALIZACION BETWEEN '2023-12-18 00:00:00' AND '2023-12-18 23:59:59';
