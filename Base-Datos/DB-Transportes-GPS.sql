...
SELECT A.* FROM VIAJE_UBICACIONES A WHERE A.FECHA_HORA BETWEEN '2023-12-24 00:00:00' AND '2023-12-24 23:59:59';
SELECT COUNT(*) NUMERO FROM VIAJE_UBICACIONES A WHERE A.FECHA_HORA BETWEEN '2023-12-24 00:00:00' AND '2023-12-24 23:59:59';

SELECT A.* FROM DISPONIBILIDAD A WHERE A.FECHA = '2023-12-24';

-- CONSULTA DE UBICACIONES DEL PROVEEDORES DE GPS :: SMS-OPEN.
SELECT A.* FROM SMS_OPEN_ENCABEZADO A WHERE A.FECHA_ACTUALIZACION BETWEEN '2023-12-24 00:00:00' AND '2023-12-24 23:59:59';
SELECT A.* FROM SMS_OPEN_DETALLE A WHERE A.ID_SMS_OPEN IN (15184);

-- CONSULTA DE UBICACIONES DEL PROVEEDORES DE GPS :: GEOTAB.
SELECT A.* FROM GEOTAB_ENCABEZADO A WHERE A.FECHA_ACTUALIZACION BETWEEN '2023-12-24 00:00:00' AND '2023-12-24 23:59:59';
SELECT A.* FROM GEOTAB_DETALLE A WHERE A.ID_GEOTAB IN (3);
...
SELECT COUNT(*) NUMERO FROM VIAJES V;
SELECT YEAR(V.FECHA_VIAJE) ANIO, MONTH(V.FECHA_VIAJE) MES, COUNT(*) NUMERO FROM VIAJES V GROUP BY YEAR(V.FECHA_VIAJE), MONTH(V.FECHA_VIAJE) ORDER BY ANIO, MES;

SELECT VU.* FROM VIAJE_UBICACIONES VU;
SELECT COUNT(*) NUMERO FROM VIAJE_UBICACIONES VU;
SELECT YEAR(VU.FECHA_HORA) ANIO, MONTH(VU.FECHA_HORA) MES, COUNT(*) NUMERO FROM VIAJE_UBICACIONES VU GROUP BY YEAR(VU.FECHA_HORA), MONTH(VU.FECHA_HORA) ORDER BY ANIO, MES;

SELECT SOE.* FROM SMS_OPEN_ENCABEZADO SOE;
SELECT COUNT(*) NUMERO FROM SMS_OPEN_ENCABEZADO SOE;

SELECT SOD.* FROM SMS_OPEN_DETALLE SOD;
SELECT COUNT(*) NUMERO FROM SMS_OPEN_DETALLE SOD;

SELECT SOD.* FROM GEOTAB_DETALLE SOD;
SELECT COUNT(*) NUMERO FROM GEOTAB_DETALLE SOD;

SELECT YEAR(STR_TO_DATE(SOD.DATETIME_UBICACION, '%d-%m-%Y %H:%i:%s')) ANIO, MONTH(STR_TO_DATE(SOD.DATETIME_UBICACION, '%d-%m-%Y %H:%i:%s')) MES, COUNT(*) NUMERO
FROM SMS_OPEN_DETALLE SOD 
GROUP BY YEAR(STR_TO_DATE(SOD.DATETIME_UBICACION, '%d-%m-%Y %H:%i:%s')), MONTH(STR_TO_DATE(SOD.DATETIME_UBICACION, '%d-%m-%Y %H:%i:%s')) ORDER BY ANIO, MES;

SELECT YEAR(STR_TO_DATE(SOD.DATETIME_UBICACION, '%Y-%m-%d %H:%i:%s')) ANIO, MONTH(STR_TO_DATE(SOD.DATETIME_UBICACION, '%Y-%m-%d %H:%i:%s')) MES, COUNT(*) NUMERO
FROM GEOTAB_DETALLE SOD 
GROUP BY YEAR(STR_TO_DATE(SOD.DATETIME_UBICACION, '%Y-%m-%d %H:%i:%s')), MONTH(STR_TO_DATE(SOD.DATETIME_UBICACION, '%Y-%m-%d %H:%i:%s')) ORDER BY ANIO, MES;

INSERT INTO SMS_OPEN_DETALLE_HISTORY_2023 
SELECT SOD.* FROM SMS_OPEN_DETALLE SOD WHERE STR_TO_DATE(SOD.DATETIME_UBICACION, '%d-%m-%Y %H:%i:%s') BETWEEN '2023-04-01 00:00:00' AND '2023-04-30 23:59:59';

SELECT SOD.* FROM SMS_OPEN_DETALLE SOD WHERE STR_TO_DATE(SOD.DATETIME_UBICACION, '%d-%m-%Y %H:%i:%s') BETWEEN '2023-04-01 00:00:00' AND '2023-04-30 23:59:59';
SELECT COUNT(*) FROM SMS_OPEN_DETALLE SOD WHERE STR_TO_DATE(SOD.DATETIME_UBICACION, '%d-%m-%Y %H:%i:%s') BETWEEN '2023-04-01 00:00:00' AND '2023-04-30 23:59:59'; -- 9117

CREATE TABLE SMS_OPEN_DETALLE_HISTORY_2023 (
  ID_SMS_OPEN bigint NOT NULL,
  CORRELATIVO bigint NOT NULL,
  NAME_VEHICULO varchar(500) DEFAULT NULL,
  ...
  DATETIME_UBICACION varchar(500) DEFAULT NULL,
  SPEED varchar(500) DEFAULT NULL,
  SPEEDMEASURE varchar(500) DEFAULT NULL,
  HEADING varchar(500) DEFAULT NULL,
  LOCATIONDESCRIPTION varchar(2000) DEFAULT NULL,
  DIRVERNAME varchar(500) DEFAULT NULL,
  DRAVERCODE varchar(500) DEFAULT NULL,
  IGNITION varchar(500) DEFAULT NULL,
  DATEUTC varchar(500) DEFAULT NULL,
  ADDRESS varchar(500) DEFAULT NULL,
  FECHA_HORA timestamp NOT NULL,
  PRIMARY KEY (ID_SMS_OPEN, CORRELATIVO),
  CONSTRAINT FK_SMS_OPEN_DETALLE_HISTORY_2023_1 FOREIGN KEY (ID_SMS_OPEN) REFERENCES SMS_OPEN_ENCABEZADO (ID_SMS_OPEN)
