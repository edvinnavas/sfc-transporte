...
SELECT A.* FROM DISPONIBILIDAD A WHERE A.FECHA='2023-07-28';
-- SELECT DATE_SUB(CURRENT_DATE, INTERVAL 7 DAY) FECHA_ELIMINAR;

SELECT A.* FROM VIAJE_UBICACIONES A;
SELECT A.* FROM VIAJE_UBICACIONES A WHERE A.FECHA_HORA BETWEEN '2023-07-22 00:00:00' AND '2023-07-22 23:59:59';
