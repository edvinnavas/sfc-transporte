...
SELECT 
    ...
    COUNT(*) NUMERO 
FROM VIAJES A 
     LEFT JOIN PAIS B ON (A.ID_PAIS=B.ID_PAIS) 
     LEFT JOIN COMPANIA C ON (A.ID_COMPANIA=C.ID_COMPANIA)
     LEFT JOIN PLANTA P ON (A.ID_PLANTA=P.ID_PLANTA)
GROUP BY A.ID_PAIS, A.ID_COMPANIA, A.ID_PLANTA;
