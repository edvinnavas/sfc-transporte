...
SELECT A.* FROM DISPONIBILIDAD A WHERE A.FECHA = '2023-10-21';
...
SELECT T.NOMBRE TRANSPORTISTA, P.NOMBRE PREDIO, V.CODIGO CISTERNA, C.CODIGO CABEZAL, A.FECHA FECHA, A.FECHA_HORA FECHA_HORA 
