...
SELECT A.* FROM SMS_OPEN_ENCABEZADO A WHERE A.FECHA_ACTUALIZACION BETWEEN '2023-11-21 00:00:00' AND '2023-11-21 23:59:59';
SELECT A.* FROM SMS_OPEN_ENCABEZADO A WHERE A.ID_SMS_OPEN=12375;
SELECT B.* FROM SMS_OPEN_DETALLE B WHERE B.ID_SMS_OPEN IN (SELECT A.ID_SMS_OPEN FROM SMS_OPEN_ENCABEZADO A WHERE A.FECHA_ACTUALIZACION BETWEEN '2023-11-21 00:00:00' AND '2023-11-21 23:59:59') AND B.NAME_VEHICULO LIKE '%SVS64 C63928%';
