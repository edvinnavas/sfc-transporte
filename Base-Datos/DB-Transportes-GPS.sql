...
SELECT A.* FROM VIAJE_UBICACIONES A WHERE A.FECHA_HORA BETWEEN '2023-12-05 00:00:00' AND '2023-12-05 23:59:59';
...
SELECT A.* FROM SMS_OPEN_ENCABEZADO A WHERE A.FECHA_ACTUALIZACION BETWEEN '2023-12-14 00:00:00' AND '2023-12-14 23:59:59';
SELECT A.* FROM SMS_OPEN_ENCABEZADO A WHERE A.ID_SMS_OPEN=14575;
SELECT COUNT(*) NUMERO FROM SMS_OPEN_DETALLE A;
SELECT B.* FROM SMS_OPEN_DETALLE B WHERE B.ID_SMS_OPEN IN (14575);

-- CONSULTA DE UBICACIONES DEL PROVEEDORES DE GPS :: GEOTAB.
SELECT COUNT(*) NUMERO FROM GEOTAB_ENCABEZADO A;
SELECT A.* FROM GEOTAB_ENCABEZADO A WHERE A.FECHA_ACTUALIZACION BETWEEN '2023-12-14 00:00:00' AND '2023-12-14 23:59:59';
SELECT A.* FROM GEOTAB_ENCABEZADO A WHERE A.ID_GEOTAB=1;
SELECT COUNT(*) NUMERO FROM GEOTAB_DETALLE A;
SELECT B.* FROM GEOTAB_DETALLE B WHERE B.ID_GEOTAB IN (1);
