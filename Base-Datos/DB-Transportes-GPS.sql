...
SELECT A.* FROM VIAJES A WHERE A.FECHA_VIAJE='2023-07-06';
SELECT A.* FROM VIAJES A WHERE A.FECHA_VIAJE='2023-07-06' AND A.ID_PAIS=6;
SELECT A.* FROM VIAJES A WHERE A.NUMERO_VIAJE=282518;
SELECT A.NUMERO_VIAJE, COUNT(*) NO_VIAJE FROM VIAJES A WHERE A.FECHA_VIAJE='2023-07-06' AND A.ID_PAIS=6 GROUP BY A.NUMERO_VIAJE ORDER BY A.NUMERO_VIAJE;
