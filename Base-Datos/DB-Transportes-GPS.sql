...
SELECT A.* FROM VIAJE_UBICACIONES A WHERE A.NUMERO_VIAJE=289046;
...
SELECT A.* FROM DISPONIBILIDAD A WHERE A.FECHA='2023-09-13';
...
SELECT A.* FROM VEHICULO A WHERE TRIM(A.CODIGO) IN ('SVSPOT12','SVSPOT18');
SELECT A.* FROM VEHICULO A WHERE TRIM(A.CODIGO) LIKE '%T18%';