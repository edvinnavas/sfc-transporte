    ...
    public Respuesta_WS_Viaje obtener_viajes(String fecha) {
        ...
        try {
            ...
            String cadenasql = "SELECT DISTINCT "
                    ...
                    + "(SELECT DISTINCT SO.SDAN8 FROM (SELECT B.SDKCOO, B.SDDCTO, B.SDDOCO, B.SDAN8 FROM PRODDTA.F4211 B UNION ALL SELECT B.SDKCOO, B.SDDCTO, B.SDDOCO, B.SDAN8 FROM PRODDTA.F42119 B) SO WHERE SO.SDDCTO=C.TDDCTO AND SO.SDDOCO=C.TDDOCO AND ROWNUM=1) CODIGO_CLIENTE, "
                    ...
                    + "(SELECT DISTINCT SO.SDSHAN FROM (SELECT B.SDKCOO, B.SDDCTO, B.SDDOCO, B.SDSHAN FROM PRODDTA.F4211 B UNION ALL SELECT B.SDKCOO, B.SDDCTO, B.SDDOCO, B.SDSHAN FROM PRODDTA.F42119 B) SO WHERE SO.SDDCTO=C.TDDCTO AND SO.SDDOCO=C.TDDOCO AND ROWNUM=1) CODIGO_CLIENTE_DESTINO, "
                    ...
                    + "(SELECT DISTINCT NVL(TRIM(SO.SDZON),'-') FROM (SELECT B.SDKCOO, B.SDDCTO, B.SDDOCO, B.SDSHAN, B.SDZON FROM PRODDTA.F4211 B UNION ALL SELECT B.SDKCOO, B.SDDCTO, B.SDDOCO, B.SDSHAN, B.SDZON FROM PRODDTA.F42119 B) SO WHERE SO.SDDCTO=C.TDDCTO AND SO.SDDOCO=C.TDDOCO AND ROWNUM=1) TIPO_FLETE_VIAJE "
                    + "FROM "
