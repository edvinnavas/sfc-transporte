...
public class Viaje implements Serializable {
    ...
    public Viaje(Pais pais, Compania compania, Planta planta, Long numero_viaje, String fecha_viaje, Estado_Viaje estado_viaje, Vehiculo vehiculo, Transportista transportista, String tipo_orden_venta, Long numero_orden_venta, Cliente cliente, Cliente_Destino cliente_destino, String tipo_flete_viaje, String fecha_hora, String estado, String fecha_hora_terminado, String disponibilidad, Vehiculo cisterna_disponibilidad, Cabezal cabezal_disponibilidad) {
        this.pais = pais;
