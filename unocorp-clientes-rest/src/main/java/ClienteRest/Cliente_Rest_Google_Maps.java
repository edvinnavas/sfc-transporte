...
public class Cliente_Rest_Google_Maps implements Serializable {
    ...
    public Cliente_Rest_Google_Maps() {
        try {
            ...
            System.out.println("PROYECTO: unocorp-clientes-rest, CLASE: " + this.getClass().getName() + ", METODO: Cliente_Rest_Google_Maps(), ERRROR: " + ex.toString());
        }
    }
    ...
    public String distancematrix(String departure_time, String origins, String destinations, String key) {
        ...
        try {
            ...
            System.out.println("PROYECTO: unocorp-clientes-rest, CLASE: " + this.getClass().getName() + ", METODO: distancematrix(), ERRROR: " + ex.toString());
        }
