...
public class Cliente_Rest_DISATEL implements Serializable {

    private static final long serialVersionUID = 1L;

    public Cliente_Rest_DISATEL() {

    }

    public String ListaVehiculos(String xml_request) {
        String xml_response = "";

        try {
            // System.out.println("XML_REQUEST: " + xml_request);
            HttpPost http_request = new HttpPost("http://srv.disatelavl.net/ws/index.php?wsdl");
            http_request.setHeader("Accept-Encoding", "gzip,deflate");
            http_request.setHeader("Content-Type", "text/xml;charset=UTF-8;");
            http_request.setHeader("SOAPAction", "\"http://srv.disatelavl.net/ws/index.php/ListaVehiculos\"");
            http_request.setHeader("Host", "srv.disatelavl.net");
            ...
            xml_response = "PROYECTO:unocorp-clientes-rest|CLASE:" + this.getClass().getName() + "|METODO:ListaVehiculos()|ERROR:" + ex.toString();
        }
