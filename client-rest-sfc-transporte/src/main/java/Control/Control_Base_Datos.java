...
public class Control_Base_Datos implements Serializable {
    ...
    final String host_mysql_db = "181.174.115.109";
    ...
    public Connection obtener_conexion_mysql() {
        ...
        try {
            String usuario_db = "shellgps";
            String contrasena_db = "sdjk7234J";

            Class.forName("com.mysql.jdbc.Driver");
            resultado = DriverManager.getConnection("jdbc:mysql://" + this.host_mysql_db + ":3306/db_gps_unocorp?autoReconnect=true&useSSL=false", usuario_db, contrasena_db);
